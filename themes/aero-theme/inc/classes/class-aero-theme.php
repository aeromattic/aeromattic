...
class AERO_THEME {
	...
	protected function _setup_theme() {
		...
		load_theme_textdomain( 'aero-theme', AERO_THEME_TEMP_DIR . '/languages' );
		...
		register_nav_menus(
			[
				'primary' => esc_html__( 'Primary Menu', 'aero-theme' ),
			]
		);
	...
	public function add_read_more_link() {
		...
		return sprintf( '<a class="moretag" href="%s">%s</a>', get_permalink( $post->ID ), esc_html__( 'Read More', 'aero-theme' ) );
	}
