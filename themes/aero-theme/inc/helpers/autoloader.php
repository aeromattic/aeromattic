...
namespace AERO_THEME\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( AERO_THEME_TEMP_DIR ), $directory, $file_name );
...
spl_autoload_register( '\AERO_THEME\Inc\Helpers\autoloader' );
