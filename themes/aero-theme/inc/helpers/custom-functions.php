 ...
 * @return void
 */
function aero_theme_primary_classes( $more_classes = false, $override_foundation_classes = false ) {
	$sidebar_position = get_theme_mod( 'aero_theme_sidebar_position' );
	...
	echo esc_html( "aero-theme-primary {$foundation_classes} {$more_classes} clearfix" );
}
 ...
 * @return void
 */
function aero_theme_secondary_classes( $more_classes = false, $override_foundation_classes = false ) {
	...
	echo esc_html( "aero-theme-secondary widget-area {$foundation_classes} {$more_classes} clearfix" );
}
 ...
 * @return void
 */
function aero_theme_get_font_url( $path ) {
	echo esc_url( get_template_directory_uri() . '/assets/fonts' . $path );
}

/**
 * aero-theme Pagination.
 */
function aero_theme_pagination() {
	...
	printf( '<nav class="aero-theme-pagination clearfix">%s</nav>', wp_kses( paginate_links(), $allowed_tags ) );
}
 ...
 * @return void
 */
function aero_theme_get_template_part( $slug, $variables = [] ) {
