	...
	<header id="masthead" class="header-wrapper grid-container grid-container-padded" role="banner">
		<div class="row grid-x grid-margin-x">
			<div class="site-branding shrink cell column">
				...
				$hide_tagline = get_theme_mod( 'aero_theme_hide_tagline' );
			...
			<a id="primary-nav-button" class="aero-theme-mobile-nav-button menu-toggle" href="#site-navigation"><?php esc_html_e( 'Mobile Menu', 'aero-theme' ); ?></a>

			<nav id="site-navigation" class="aero-theme-main-navigation auto cell column" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'aero-theme' ); ?>">
				<?php
				wp_nav_menu(
					[
